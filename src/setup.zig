...
fn createPlayer(self: *Game) !void {
    ...
    // player_component.body.slots[1].?.owner = player;
    // player_component.inventory.items[0] = .weapon_mod_damage;
    // player_component.inventory.items[0].?.owner = player;
    // player_component.inventory.items[1] = .weapon_mod_damage;
    // player_component.inventory.items[1].?.owner = player;
    // player_component.inventory.items[2] = .body_mod_shield;
    // player_component.inventory.items[2].?.owner = player;
    // player_component.inventory.items[3] = .body_mod_shield;
    // player_component.inventory.items[3].?.owner = player;
    // player_component.inventory.items[4] = .body_mod_shield;
    // player_component.inventory.items[4].?.owner = player;
    // player_component.inventory.items[5] = .body_mod_shield;
    // player_component.inventory.items[5].?.owner = player;
