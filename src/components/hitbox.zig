...
pub const Hitbox = struct {
    ...
    pub fn top(self: Hitbox) f32 {
        return self.position().y;
    }

    pub fn bottom(self: Hitbox) f32 {
        return self.position().y + self.size().y;
    }

    pub fn left(self: Hitbox) f32 {
        return self.position().x;
    }

    pub fn right(self: Hitbox) f32 {
    ...
    pub fn distanceTo(self: Hitbox, other: Hitbox) f32 {
